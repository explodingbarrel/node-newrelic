  ...
  function wrapRequestListener(listener) {
    ...
    return function wrappedHandler(request, response) {
      ...
      function instrumentedFinish() {
         ...
         * Added: normalizedUrl if application wants to use their router's url
         * Added: http method to beginning to differentiate between different method of the same url.
         */
        var url = '/' + request.method.toLowerCase() + (request.normalizedUrl || request.originalUrl || request.url);
